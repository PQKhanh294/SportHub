...
namespace SportHub.Middleware
{
    public class UiLocalizationMiddleware
    {
        ...
        private static readonly IReadOnlyList<TextEntry> Entries = new List<TextEntry>
        {
            ...
            new("Bạn chưa cập nhật môn thể thao & trình độ. Hãy hoàn thiện hồ sơ để tham gia trận.", "You haven't set your sport & skill level yet. Complete your profile to join matches."),
            new("Trình độ của bạn chưa phù hợp với yêu cầu của trận này.", "Your skill level does not meet this match's requirement."),
            new("Trận đã đủ người.", "This match is already full."),
            new("Trận đã bị host khóa đăng ký.", "The host has locked registrations for this match."),
            new("Trận đã đóng đăng ký.", "Registrations are closed for this match."),
            new("Bạn đã gửi yêu cầu tham gia trận này rồi.", "You have already requested to join this match."),
            new("Trận đấu không tồn tại.", "This match does not exist."),
            new("Không thể tham gia trận đấu.", "Unable to join this match."),
