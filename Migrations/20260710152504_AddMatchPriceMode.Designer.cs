...
namespace SportHub.Migrations
{
    ...
    [Migration("20260710152504_AddMatchPriceMode")]
    partial class AddMatchPriceMode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportHub.Models.Entities.CommunityListing", b =>
                {
                    b.Property<int>("CommunityListingID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CommunityListingID"));

                    b.Property<string>("Address")
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal?>("CostFemaleVnd")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("CostMaleVnd")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("ParsedJsonRaw")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SportHub.Models.Entities.DisputeWitnessResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DisputeId", "WitnessUserId")
                        .IsUnique();

                    b.ToTable("DisputeWitnessResponses", (string)null);
                });

            modelBuilder.Entity("SportHub.Models.Entities.EmailLog", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Models.Entities.Notification", b =>
                {
                    ...
                    b.ToTable("Notifications", null, t =>
                        {
                            t.HasCheckConstraint("CK_Notifications_Type", "Type IN ('MatchJoin','MatchApprove','MatchReject','MatchJoinExpired','BookingConfirmed','BookingCancelled','System','Chat','MatchPaymentRequired','MatchRemainingFeeRequired','MatchPaymentConfirmed','MatchCompleted','MatchReviewReminder','RemainingFeeReminder','WalletCredit','Promotion','AdminCredit','Voucher')");
                        });
                });
            ...
            modelBuilder.Entity("SportHub.Models.Entities.PromoCode", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Models.Entities.PromotionCampaign", b =>
                {
                    b.Property<int>("CampaignID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportHub.Models.Entities.PromotionRedemption", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Models.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("NotifyMatchApproved")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyMatchCancelled")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyMatchJoinRequest")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyMatchReminder")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyPaymentReminder")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyPromoCode")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyWalletCredit")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("ShowContactToTeammates")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SportHub.Models.Entities.UserVoucher", b =>
                {
                    b.Property<int>("VoucherID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportHub.Models.Entities.CommunityListing", b =>
                {
                    ...
                    b.HasOne("SportHub.Models.Entities.User", "SubmittedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SportHub.Models.Entities.DisputeWitnessResponse", b =>
                {
                    b.HasOne("SportHub.Models.Entities.MatchDispute", "Dispute")
                        .WithMany("WitnessResponses")
                        .HasForeignKey("DisputeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SportHub.Models.Entities.User", "Witness")
                        .WithMany()
            ...
            modelBuilder.Entity("SportHub.Models.Entities.PromoCode", b =>
                {
                    b.HasOne("SportHub.Models.Entities.PromotionCampaign", "Campaign")
                        .WithMany("PromoCodes")
            ...
            modelBuilder.Entity("SportHub.Models.Entities.PromotionCampaign", b =>
                {
                    b.HasOne("SportHub.Models.Entities.User", "CreatedByAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("SportHub.Models.Entities.PromotionRedemption", b =>
                {
                    ...
                    b.HasOne("SportHub.Models.Entities.PromoCode", "PromoCode")
                        .WithMany()
                    ...
                    b.HasOne("SportHub.Models.Entities.UserVoucher", "Voucher")
                        .WithMany()
                        .HasForeignKey("VoucherID")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("SportHub.Models.Entities.WalletTransaction", "WalletTransaction")
                        .WithMany()
            ...
            modelBuilder.Entity("SportHub.Models.Entities.UserVoucher", b =>
                {
                    ...
                    b.HasOne("SportHub.Models.Entities.User", "IssuedByAdmin")
                        .WithMany()
