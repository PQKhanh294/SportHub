...
namespace SportHub.Migrations
{
    ...
    [Migration("20260610142509_SportHubUxEnhancements")]
    partial class SportHubUxEnhancements
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SportHub.Models.Entities.Notification", b =>
                {
                    ...
                    b.ToTable("Notifications", null, t =>
                        {
                            t.HasCheckConstraint("CK_Notifications_Type", "Type IN ('MatchJoin','MatchApprove','MatchReject','MatchJoinExpired','BookingConfirmed','BookingCancelled','System','Chat')");
                        });
                });
