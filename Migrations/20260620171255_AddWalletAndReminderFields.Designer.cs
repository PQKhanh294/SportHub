...
namespace SportHub.Migrations
{
    ...
    [Migration("20260620171255_AddWalletAndReminderFields")]
    partial class AddWalletAndReminderFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SportHub.Models.Entities.WalletTransaction", b =>
                {
                    ...
                    b.ToTable("WalletTransactions", null, t =>
                        {
                            t.HasCheckConstraint("CK_WalletTransactions_Type", "Type IN ('Refund','Deduction','AdminCredit')");
                        });
                });
